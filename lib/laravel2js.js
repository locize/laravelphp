...
export default function laravelToJs (str, cb) {
  if (!cb) {
    return new Promise((resolve, reject) => laravelToJsClb(str, (err, ret) => err ? reject(err) : resolve(ret)))
  }
